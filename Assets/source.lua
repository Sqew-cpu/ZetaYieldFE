if IY_LOADED and not _G.IY_DEBUG == true then
    -- error("Zeta  Yield is already running!", 0)
    return
end
...
-- zeta•elif
local iyassets = {
    ["ZetaYieldFE/assets/bindsandplugins.png"] = "rbxassetid://5147695474",
    ["ZetaYieldFE/assets/close.png"] = "rbxassetid://5054663650",
    ["ZetaYieldFE/assets/editaliases.png"] = "rbxassetid://5147488658",
    ["ZetaYieldFE/assets/editkeybinds.png"] = "rbxassetid://129697930",
    ["ZetaYieldFE/assets/edittheme.png"] = "rbxassetid://4911962991",
    ["ZetaYieldFE/assets/editwaypoints.png"] = "rbxassetid://5147488592",
    ["ZetaYieldFE/assets/imgstudiopluginlogo.png"] = "rbxassetid://4113050383",
    ["ZetaYieldFE/assets/logo.png"] = "rbxassetid://1352543873",
    ["ZetaYieldFE/assets/minimize.png"] = "rbxassetid://2406617031",
    ["ZetaYieldFE/assets/pin.png"] = "rbxassetid://6234691350",
    ["ZetaYieldFE/assets/reference.png"] = "rbxassetid://3523243755",
    ["ZetaYieldFE/assets/settings.png"] = "rbxassetid://1204397029"
}
...
if makefolder and isfolder and writefile and isfile then
    pcall(function() -- good executor trust
        local assets = "https://raw.githubusercontent.com/Sqew-cpu/ZetaYieldFE/main/Assets/"
        for _, folder in {"ZetaYieldFE", "ZetaYieldFE/assets"} do
        ...
        for path in iyassets do
            if not isfile(path) then
                writefile(path, game:HttpGet((path:gsub("ZetaYieldFE/", assets))))
            end
        end
        if IsOnMobile then writefile("ZetaYieldFE/assets/.nomedia") end
    end)
end
...
Title.TextSize = 18
Title.Text = "Zeta yield FE v" .. currentVersion
...
SettingsButton.Image = getcustomasset("ZetaYieldFE/assets/settings.png")
...
ReferenceButton.Image = getcustomasset("ZetaYieldFE/assets/reference.png")
...
ColorsButton = makeSettingsButton("Edit Theme",getcustomasset("ZetaYieldFE/assets/edittheme.png"))
ColorsButton.Position = UDim2.new(0, 5, 0, 55)
ColorsButton.Size = UDim2.new(1, -10, 0, 25)
ColorsButton.Name = "Colors"
ColorsButton.Parent = SettingsHolder

Keybinds = makeSettingsButton("Edit Keybinds",getcustomasset("ZetaYieldFE/assets/editkeybinds.png"))
Keybinds.Position = UDim2.new(0, 5, 0, 85)
Keybinds.Size = UDim2.new(1, -10, 0, 25)
Keybinds.Name = "Keybinds"
Keybinds.Parent = SettingsHolder

Aliases = makeSettingsButton("Edit Aliases",getcustomasset("ZetaYieldFE/assets/editaliases.png"))
...
Positions = makeSettingsButton("Edit/Goto Waypoints",getcustomasset("ZetaYieldFE/assets/editwaypoints.png"))
Positions.Position = UDim2.new(0, 5, 0, 145)
Positions.Size = UDim2.new(1, -10, 0, 25)
Positions.Name = "Waypoints"
Positions.Parent = SettingsHolder

EventBind = makeSettingsButton("Edit Event Binds",getcustomasset("ZetaYieldFE/assets/bindsandplugins.png"),759)
EventBind.Position = UDim2.new(0, 5, 0, 205)
EventBind.Size = UDim2.new(1, -10, 0, 25)
EventBind.Name = "EventBinds"
EventBind.Parent = SettingsHolder

Plugins = makeSettingsButton("Manage Plugins",getcustomasset("ZetaYieldFE/assets/bindsandplugins.png"),743)
...
CloseImage.Image = getcustomasset("ZetaYieldFE/assets/close.png")
...
PinImage.ZIndex = 10
PinImage.Image = getcustomasset("ZetaYieldFE/assets/pin.png")
...
Logo.Image = getcustomasset("ZetaYieldFE/assets/logo.png")
...
ExitImage_2.Image = getcustomasset("ZetaYieldFE/assets/close.png")
...
Img.Image = getcustomasset("ZetaYieldFE/assets/imgstudiopluginlogo.png")
Img.ZIndex = 10
...
ExitImage_3.Image = getcustomasset("ZetaYieldFE/assets/close.png")
...
ExitImage_5.Image = getcustomasset("ZetaYieldFE/assets/close.png")
...
ImageLabel.Image = getcustomasset("ZetaYieldFE/assets/minimize.png")
...
ImageLabel_2.Image = getcustomasset("ZetaYieldFE/assets/close.png")
...
eventEditor = (function()
	...
	local main = create({
		...
		{5,"ImageLabel",{BackgroundColor3=Color3.new(1,1,1),BackgroundTransparency=1,Image=getcustomasset("ZetaYieldFE/assets/close.png"),Parent={4},Position=UDim2.new(0,5,0,5),Size=UDim2.new(0,10,0,10),ZIndex=10,}},
		...
		{53,"ImageLabel",{BackgroundColor3=Color3.new(1,1,1),BackgroundTransparency=1,Image=getcustomasset("ZetaYieldFE/assets/settings.png"),Parent={52},Position=UDim2.new(0,2,0,2),Size=UDim2.new(0,16,0,16),ZIndex=10,}},
	})
	main.Name = randomString()
...
createPopup = function(text)
    ...
    ExitImage.Image = getcustomasset("ZetaYieldFE/assets/close.png")
    ExitImage.ZIndex = 10
...
SaveChatlogs.MouseButton1Down:Connect(function()
	if writefileExploit() then
		if #scroll_2:GetChildren() > 0 then
			...
			local writelogs = '-- Zeta Yield Chat logs for "'..placeName..'"\n'
			for _, child in pairs(scroll_2:GetChildren()) do
				writelogs = writelogs..'\n'..child.Text
			end
...
CMDs = {}
CMDs[#CMDs + 1] = {NAME = 'discord / support / help', DESC = 'Invite to the Zeta Yield support server.'}
...
Players.LocalPlayer.OnTeleport:Connect(function(State)
	if KeepInfYield and (not TeleportCheck) and queueteleport then
		TeleportCheck = true
		queueteleport("loadstring(game:HttpGet('https://raw.githubusercontent.com/EdgeIY/ZetaYieldFE/master/source'))()")
	end
end)
...
task.spawn(function()
	local success, latestVersionInfo = pcall(function() 
		local versionJson = game:HttpGet("https://raw.githubusercontent.com/EdgeIY/ZetaYieldFE/master/version")
...
task.spawn(function()
	...
	minimizeHolder()
	if IsOnMobile then notify("Unstable Device", "On mobile, Zeta Yield may have issues or features that are not functioning correctly.") end
end)
